...
export function isColorSupported(color: string | number) {
...
export function getHexColorInt(color: string | number) {
	if (typeof color === "string") {
		if (color.startsWith("#") || color.startsWith("0x")) return parseInt(color.replace("#", "0x"), 16);
